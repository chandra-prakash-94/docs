...
| - | --------- | ------- | ------- |
| Value add | Abstractions <br></br> Integrations | Durable execution<br></br>Streaming<br></br>HITL<br></br>Persistence | Predefined tools<br></br>Prompts<br></br>Subagents |
| When to use | Getting started quickly<br></br>Standardizing how a team builds | Low-level control<br></br>Long running, stateful workflows and agents | More autonomous agents<br></br>Agents faced with complex, non-deterministic tasks |
