...
Additionally, you can create evaluators in the LangSmith UI and bind them to your dataset. For evaluators defined in the UI and bound to your dataset, they will automatically run on experiment traces. To learn more about evaluators, see [Evaluators](/langsmith/evaluation-concepts#evaluators).
...
for example in client.list_examples(dataset_name=dataset_name):
    ...
    # Adjust the key based on your dataset structure (e.g., "input", "question", etc.)
...
After running the evaluation, you can view the experiment in the LangSmith UI to see:
