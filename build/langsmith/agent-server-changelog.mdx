...
- Added support for updating existing cron jobs, allowing modifications to all fields except assistant and thread IDs.
</Update>

<Update label="2026-02-04" tags={["agent-server"]}>
## v0.7.19

- Introduced a gRPC Go client for custom encryption, enhancing the integration between the Go server and encryption services.
</Update>
